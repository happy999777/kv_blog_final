...
DATABASES = {
    'default': dj_database_url.config(
        default=config(
            'DATABASE_URL',
            default='postgresql://postgres:YOUR_PASSWORD@localhost:5432/kvblog'
        ),
        conn_max_age=600
    )
}
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='BlogPlatform <noreply@blogplatform.com>')
...
CKEDITOR_5_CONFIGS = {
    'default': {
        'toolbar': ['heading', '|', 'bold', 'italic', 'link', 'bulletedList', 'numberedList', 'blockQuote',
                    'imageUpload', 'mediaEmbed', 'insertTable', 'codeBlock', 'sourceEditing'],
        'height': '400px',
    },
}
